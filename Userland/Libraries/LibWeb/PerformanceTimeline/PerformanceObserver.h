...
public:
    ...
    WebIDL::ExceptionOr<void> observe(PerformanceObserverInit const& options);
    void disconnect();
    ...
    ErrorOr<void> append_to_observer_buffer(Badge<HTML::WindowOrWorkerGlobalScopeMixin>, JS::Handle<PerformanceTimeline::PerformanceEntry>);
...
private:
    ...
    Vector<JS::Handle<PerformanceTimeline::PerformanceEntry>> m_observer_buffer;

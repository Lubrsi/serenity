...
PerformanceObserverEntryList::PerformanceObserverEntryList(JS::Realm& realm, Vector<JS::Handle<PerformanceTimeline::PerformanceEntry>>&& entry_list)
...
JS::ThrowCompletionOr<void> PerformanceObserverEntryList::initialize(JS::Realm& realm)
{
...
ErrorOr<Vector<JS::Handle<PerformanceTimeline::PerformanceEntry>>> filter_buffer_by_name_and_type(Vector<JS::Handle<PerformanceTimeline::PerformanceEntry>> const& buffer, Optional<String> name, Optional<String> type)
{

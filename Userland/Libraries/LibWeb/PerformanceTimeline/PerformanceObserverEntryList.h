...
private:
    PerformanceObserverEntryList(JS::Realm&, Vector<JS::Handle<PerformanceTimeline::PerformanceEntry>>&&);
    ...
    Vector<JS::Handle<PerformanceTimeline::PerformanceEntry>> m_entry_list;
};

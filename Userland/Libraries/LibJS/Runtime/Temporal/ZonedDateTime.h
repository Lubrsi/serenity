...
ThrowCompletionOr<TemporalDuration> difference_zoned_date_time(GlobalObject&, BigInt const& nanoseconds1, BigInt const& nanoseconds2, Value time_zone, Object& calendar, StringView largest_unit, Object* options = nullptr);

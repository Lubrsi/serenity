...
public:
   ...
   static ErrorOr<NonnullRefPtr<Font>> try_load_from_externally_owned_memory(Core::Stream::SeekableStream&);
   ...
   virtual Gfx::ScaledGlyphMetrics glyph_metrics(u32 glyph_id, float x_scale, float y_scale) const override { dbgln("woff2 glyph metrics {} {} {}", glyph_id, x_scale, y_scale); return m_input_font->glyph_metrics(glyph_id, x_scale, y_scale); }
   ...
   virtual RefPtr<Gfx::Bitmap> rasterize_glyph(u32 glyph_id, float x_scale, float y_scale) const override { dbgln("woff2 rasterize {} {} {}", glyph_id, x_scale, y_scale); return m_input_font->rasterize_glyph(glyph_id, x_scale, y_scale); }

...
public:
    Image(Device& device, void const* ownership_token, GPU::PixelFormat const&, u32 width, u32 height, u32 depth, u32 max_levels);
    ...
    Protocol::ResourceID resource_id() const { return m_resource_id; }
    Protocol::TextureFormat texture_format() const;

private:
    Device& m_device;
    Protocol::ResourceID m_resource_id;
};
